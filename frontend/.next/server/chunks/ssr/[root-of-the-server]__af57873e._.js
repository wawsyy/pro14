...
"[project]/frontend/utils/errorHandler.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function handleNonCriticalError(error, context) {
    if (isNonCriticalError(error)) {
        ...
        console.log(`[Non-critical error${context ? ` - ${context}` : ""}] ${friendlyMessage}`);
        return;
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$errorHandler$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/utils/errorHandler.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Providers({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const handleError = (event)=>{
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$errorHandler$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNonCriticalError"])(error)) {
...
class ErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Component"] {
    ...
    componentDidCatch(error, errorInfo) {
        ...
        const errorObj = error instanceof Error ? error : new Error(typeof error === 'object' && error !== null ? `Non-Error object caught: ${Object.keys(error).join(', ')}` : String(error));
        // If non-critical error, silently handle (log to console only)
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$errorHandler$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNonCriticalError"])(errorObj)) {
    ...
    render() {
        if (this.state.hasError && this.state.error) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$errorHandler$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNonCriticalError"])(this.state.error)) {
            ...
            const errorMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$errorHandler$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFriendlyErrorMessage"])(this.state.error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af57873e._.js.map